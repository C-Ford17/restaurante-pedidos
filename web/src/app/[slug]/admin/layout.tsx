    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex">
            ...
            <button
                ...
                className={`fixed left-4 top-20 z-50 p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all ${sidebarOpen ? 'left-64' : ''
                    }`}
            >
                <Menu size={20} />
            </button>
