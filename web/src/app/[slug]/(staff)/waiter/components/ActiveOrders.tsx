import { Activity, Coffee, Edit3, Trash2, Receipt, DollarSign } from 'lucide-react'
                                            ...
                                            <>
                                                {(allServed || order.status === 'servido') && order.status !== 'listo_pagar' && (
                                                    <button
                                                        ...
                                                        className="p-2.5 bg-blue-100 text-blue-600 rounded-xl hover:bg-blue-200 transition-colors shadow-sm animate-in zoom-in duration-300"
                                                ...
                                                {(allServed || order.status === 'servido' || order.status === 'listo_pagar') && (
                                                    <button
                                                        ...
                                                        className="p-2.5 bg-green-100 text-green-600 rounded-xl hover:bg-green-200 transition-colors shadow-sm animate-in zoom-in duration-300"
